...
<div class="title flex flex-between flex-align-center <?php echo e($room); ?>">
    ...
    <a href="/history/jackpot"><?php echo e(__('platform.jackpot.button.history')); ?></a>
</div>

<div class="content">
    <div class="alert" style="margin-bottom: 15px;">
        <span><?php echo e(__('platform.jackpot.warning.referral')); ?></span>
        <span class="alert-close tooltip" data-close="alert" title="<?php echo e(__('platform.close')); ?>">×</span>
    </div>
    ...
    <div class="game-content flex flex-between">
            ...
            <div class="block">
                <div class="bet methods-value bg">
                   <?php if(auth()->guard()->guest()): ?>
                    <span><?php echo e(__('platform.login')); ?></span>
                   <?php else: ?>
                   <div class="value">
                        <input type="text" id="amount" placeholder="<?php echo e(__('platform.wageramount')); ?>">
                   </div>
                    <a  class="bet-b makeBet"><?php echo e(__('platform.button.placebet')); ?></a>
                    <ul>
                        ...
                        <li><a  data-method="all"><?php echo e(__('platform.button.max')); ?></a></li>
                        <li><a  data-method="clear"><?php echo e(__('platform.button.clearbet')); ?></a></li>
                    </ul>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="bets">
            <div class="users-in-game flex flex-center flex-align-center">
                <span class="head"><?php echo e(__('platform.jackpot.players')); ?></span>
            ...
            <div class="scroll" id="bets_<?php echo e($room); ?>">
                ...
                <div class="bet flex flex-between">
                    <div class="left">
                        ...
                        <div class="tickets"><span><?php echo e(__('platform.jackpot.tickets')); ?></span> <b><?php echo e(round($bet->from)); ?> - <?php echo e(round($bet->to)); ?></b></div>
            ...
            <div class="fair-game">
                <h4><?php echo e(__('platform.jackpot.ready')); ?></h4>
                <p><b>#<?php echo e($game->game_id); ?></b> Hash round: <span id="hash_<?php echo e($room); ?>"><?php echo e($game->hash); ?></span></p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/ploi/pvp.bulk.bet/resources/views/pages/games/jackpot.blade.php ENDPATH**/ ?>