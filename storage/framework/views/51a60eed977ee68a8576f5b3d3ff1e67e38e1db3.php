...
<html lang="en">
	...
	<body class="chat-mobile">
		...
		<div class="header flex flex-between flex-align-center">
		        ...
		        <div class="rooms">
		            <ul>
		                <li class="small tooltip" title="От 1 до 50">
		                    <a href="/?room=small">
		                        <span><span class="name">Бомж</span> <b id="roombank_small"><?php echo e(\App\Jackpot::getBank('small')); ?> <i class="fas fa-coins"></i></b></span>
		                    </a>
		                </li>
		                <li class="classic tooltip" title="От 10 до 500">
		                    <a href="/?room=classic">
		                        <span><span class="name">Классик</span> <b id="roombank_classic"><?php echo e(\App\Jackpot::getBank('classic')); ?> <i class="fas fa-coins"></i></b></span>
		                    </a>
		                </li>
		                <li class="major tooltip" title="От 100 до 1000">
		                    <a href="/?room=major">
		                        <span><span class="name">Мажор</span> <b id="roombank_major"><?php echo e(\App\Jackpot::getBank('major')); ?> <i class="fas fa-coins"></i></b></span>
		                    </a>
		                </li>
		            </ul>
		        </div>
		    ...
		    <div class="group">
		        <a href="<?php echo e($settings->tg_url); ?>" target="_blank"><i class="fab fa-telegram-plane"></i> Наш Telegram канал</a>
		    </div>
		</div>
