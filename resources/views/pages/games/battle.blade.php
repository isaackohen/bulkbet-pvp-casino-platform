                ...
                <div class="history">
                    <div class="scroll" id="history">
                        @foreach($lastwins as $game) 
                            <a href="/fair/{{$game->hash}}"><div class="hist {{ $game->winner_team }} tooltip-right" title="Проверить игру"></div></a>
                        @endforeach
                    </div>
                </div>
            </div>
                ...
                <div class="right">
                    <div class="chances flex flex-between flex-align-center">
                        <div class="chance red flex flex-align-center flex-center">
                            <div>
                                <h4 id="red_persent">{{$chances[0]}}%</h4>
                                <p>1 - <span id="red_tickets">{{$tickets[0]}}</span></p>
                            </div>
                        </div>
                        <div class="chance blue flex flex-align-center flex-center">
                            <div>
                                <h4 id="blue_persent">{{$chances[1]}}%</h4>
                                <p><span id="blue_tickets">{{$tickets[1]}}</span> - 1000</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bets flex flex-between">
            <div class="red-team team">
                <div class="heading flex flex-between flex-align-center">
                    <span class="game-price" id="red_sum">{{$bank[0]}} <i class="fas fa-coins"></i></span>
                    <span class="x" id="red_factor">{{ $factor[0] ? 'x'.$factor[0] : '' }}</span>
                </div>
            ...
            <div class="blue-team team">
                <div class="heading flex flex-between flex-align-center">
                    <span class="game-price" id="blue_sum">{{$bank[1]}} <i class="fas fa-coins"></i></span>
                    <span class="x" id="blue_factor">{{ $factor[1] ? 'x'.$factor[1] : '' }}</span>
                </div>
